...
faceDetect=cv2.CascadeClassifier(r'C:\Users\KALATRI\Desktop\face reco\haarcascade_frontalface_default.xml');
cam=cv2.VideoCapture(0);

def insertOrUpdate(Id,Name,Age,Gen):
    conn=sqlite3.connect(r"C:\Users\KALATRI\Desktop\face reco\sqlite.db")
...
while(True):
    ...
    for(x,y,w,h) in faces:
        ...
        cv2.imwrite(r"C:\Users\KALATRI\Desktop\face reco\data\User."+str(Id)+"."+str(sampleNum)+".jpg",gray[y:y+h,x:x+w])
